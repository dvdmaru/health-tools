...
## 男 7.0、女 6.0 那組數字，本站查的四份指引裡一份也沒有

MedlinePlus 寫，尿酸是身體分解普林這類化合物時產生的正常廢物，正常情況下溶在血裡、由腎臟濾出，再隨尿液排出體外；報告上的單位是 mg/dL。國健署成人預防保健的血液生化檢查項目裡列有尿酸，那一頁沒給判準數字。風濕病醫學會 2016 年與日本 2019 年指引都寫不分性別的 >7.0；男女分開的 7.70 與 6.60，依同一份 2016 年指引是流行病學調查用的定義，不是診斷判準。

## 台灣和日本都畫在 7.0，ACR 寫 6.8，EULAR 連定義都沒給

同一個數字，不同機構的判準不一樣，以下並列，不選邊。判準值欄先標明那一列是診斷定義，還是篩檢分流。
...
利尿劑（loop 或 thiazide）、低劑量阿斯匹林、抗結核藥與環孢靈，2016 年指引列在藥物引起的高尿酸血症那一段；酒精及含果糖飲料代謝為乳酸會影響尿酸排泄，高脂肪食物會抑制排泄。脫水、慢性腎衰竭、限鹽、飢餓只列在相關因子表裡，來源沒寫方向。同一份 2016 年指引另外寫，約有 30% 的病患在急性痛風關節炎發作時，血尿酸值處於 <7.0 mg/dL。

## 尿酸 7.0 到 8.0 mg/dL 且無關節症狀，指引寫的是問病史、做檢查、每 6 個月追蹤

風濕病醫學會 2016 年指引對尿酸 7.0 到 8.0 mg/dL 且無關節症狀者，寫的是詢問病史、做身體檢查，並每 6 個月追蹤檢驗一次。同一份指引把利尿劑（loop 或 thiazide）與抗結核藥列在會引起高尿酸血症的藥物之列。是否進一步檢查、隔多久再驗，可以和醫師討論。
