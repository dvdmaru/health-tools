...
BMI 是國際通用的肥胖指標，腰圍代表的是脂肪的分布，兩項都列在成人預防保健的身體檢查項目裡。國健署代謝症候群頁的腹部肥胖門檻，男性 ≧90cm、女性 ≧80cm；這組數字目前可追到的最早出處，是 2000 年一份亞太報告寫給亞洲人的過渡值。
...
這個組合代表什麼，可以和醫師討論；NHLBI 的表註寫的是，腰圍偏高在體重正常的人身上有可能也是風險標記。量腰圍的位置與呼吸相都會影響數字，這次是怎麼量的，也可以和醫師討論。
